...
from megatron.plugin.dsa_kernel.backends.cudnn_flashmla import fused_ops as dk
from megatron.plugin.dsa_kernel.backends.cudnn_flashmla.fused_ops import (
...
class TestRealKernelScoreHelpers:
    ...
    def test_real_score_helper(self, case, reset_lazy_kernel_state):
        ...
        from megatron.plugin.dsa_kernel.backends.cudnn_flashmla import fused_ops as _dk
...
class TestPublicApi:
    ...
    def test_public_surface(self):
        from megatron.plugin.dsa_kernel.backends.cudnn_flashmla import fused_ops as dsa_kernels
